...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssetComment.date'
        db.alter_column(u'aidsbank_assetcomment', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'AssetComment.date'
        db.alter_column(u'aidsbank_assetcomment', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
