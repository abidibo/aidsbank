...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.province'
        db.add_column(u'aidsbank_applicant', 'province',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.province'
        db.delete_column(u'aidsbank_applicant', 'province')
