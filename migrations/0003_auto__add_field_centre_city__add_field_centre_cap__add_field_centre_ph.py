...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Centre.city'
        db.add_column(u'aidsbank_centre', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Centre.cap'
        db.add_column(u'aidsbank_centre', 'cap',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)

        # Adding field 'Centre.phone'
        db.add_column(u'aidsbank_centre', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'Centre.fax'
        db.add_column(u'aidsbank_centre', 'fax',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Centre.city'
        db.delete_column(u'aidsbank_centre', 'city')

        # Deleting field 'Centre.cap'
        db.delete_column(u'aidsbank_centre', 'cap')

        # Deleting field 'Centre.phone'
        db.delete_column(u'aidsbank_centre', 'phone')

        # Deleting field 'Centre.fax'
        db.delete_column(u'aidsbank_centre', 'fax')
