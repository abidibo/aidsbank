...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loan.status'
        db.alter_column(u'aidsbank_loan', 'status', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1))
        # Adding field 'Asset.condition'
        db.add_column(u'aidsbank_asset', 'condition',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Loan.status'
        db.alter_column(u'aidsbank_loan', 'status', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
        # Deleting field 'Asset.condition'
        db.delete_column(u'aidsbank_asset', 'condition')
