...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loan.addressee'
        db.alter_column(u'aidsbank_loan', 'addressee', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Loan.place'
        db.alter_column(u'aidsbank_loan', 'place', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Loan.addressee'
        db.alter_column(u'aidsbank_loan', 'addressee', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Loan.place'
        db.alter_column(u'aidsbank_loan', 'place', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
