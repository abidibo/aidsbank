...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.laon'
        db.delete_column(u'aidsbank_asset', 'laon')

        # Adding field 'Asset.loan_available'
        db.add_column(u'aidsbank_asset', 'loan_available',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Asset.laon'
        db.add_column(u'aidsbank_asset', 'laon',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)

        # Deleting field 'Asset.loan_available'
        db.delete_column(u'aidsbank_asset', 'loan_available')
