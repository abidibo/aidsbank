...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Centre.description'
        db.add_column(u'aidsbank_centre', 'description',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Centre.description'
        db.delete_column(u'aidsbank_centre', 'description')
