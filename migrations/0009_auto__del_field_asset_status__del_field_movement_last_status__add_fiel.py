...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.status'
        db.delete_column(u'aidsbank_asset', 'status')

        # Deleting field 'Movement.last_status'
        db.delete_column(u'aidsbank_movement', 'last_status')

        # Adding field 'Movement.status'
        db.add_column(u'aidsbank_movement', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Asset.status'
        db.add_column(u'aidsbank_asset', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movement.last_status'
        db.add_column(u'aidsbank_movement', 'last_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Movement.status'
        db.delete_column(u'aidsbank_movement', 'status')
