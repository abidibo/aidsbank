...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan.renew_available'
        db.delete_column(u'aidsbank_loan', 'renew_available')

        # Adding field 'Loan.renewal_available'
        db.add_column(u'aidsbank_loan', 'renewal_available',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Loan.renew_available'
        db.add_column(u'aidsbank_loan', 'renew_available',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Deleting field 'Loan.renewal_available'
        db.delete_column(u'aidsbank_loan', 'renewal_available')
